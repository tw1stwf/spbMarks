...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int draw_24 = R.drawable.tavpark;
        int draw_25 = R.drawable.udelpark;
        int draw_26 = R.drawable.gagarin;
        int draw_27 = R.drawable.rostral;
        int draw_28 = R.drawable.nikolaimonum;
        ...
        db.execSQL("INSERT OR IGNORE INTO sights (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (24, " + draw_24 + ", 'Таврический сад' , 'Чернышевская.', 'Потёмкинская ул', false, '1783 г.', 'Памятник садово-паркового искусства в центральной части Санкт-Петербурга. Располагается в квартале, ограниченном Кирочной, Потёмкинской, Шпалерной и Таврической улицами. Площадь Таврического сада составляет 21,1 гектар." +
                "Название сада, как и одноимённых дворца и улицы, связаны с именем российского государственного и военного деятеля времен Екатерины II Г. А.Потёмкина, получившего титул князя Таврического и усадебные земли (сад и дворец) за руководство успешной попыткой покорения для России Крыма, известного также с античных времен под древнегреческим названием Таврида. Крымское ханство в результате войны перестало угрожать России. Сад и дворец составляли единый ландшафтно-архитектурный комплекс.', 'Отсутствует', 59.9461679,  30.3746755, 'https://orangery-spb.ru/', 6, '06:00', '01:00', 'Бесплатно', 'Бесплатно')");

        db.execSQL("INSERT OR IGNORE INTO sights (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (25, " + draw_25 + ", 'Удельный парк' , 'Удельная.', 'пр. Энгельса, 28А', false, '1832 г.', 'Парк, расположенный в северной части Санкт-Петербурга, на территории, ограниченной проспектом Энгельса, проспектом Испытателей, улицей Марка Галлая, Коломяжским проспектом, а также улицей Аккуратова. В 1999 году Удельный парк отнесён к выявленным памятникам культурного наследия как объект ландшафтной архитектуры, а в 2013 году был признан объектом культурного наследия регионального значения.', 'Отсутствует', 60.0051098,  30.3162046, 'https://ru.wikipedia.org/wiki/%D0%A3%D0%B4%D0%B5%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9_%D0%BF%D0%B0%D1%80%D0%BA', 6, '00:00', '24:00', 'Бесплатно', 'Бесплатно')");

        db.execSQL("INSERT OR IGNORE INTO sights (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (26, " + draw_26 + ", 'Гагарин парк' , 'Парк победы.', 'Кузнецовская ул., 25', false, '2003 г.', 'Гагарин Парк находится на территории Московского парка Победы в Санкт-Петербурге, к югу от центра города. Благодаря аттракционам на любой вкус и удобному расположению, это место отдыха популярно среди семей с детьми. Парк поделен на зоны, отличающиеся тематикой и возрастными категориями. Большинство аттракционов находится под открытым небом, кроме отдельно стоящей крытой игротеки с игровыми автоматами.', 'Отсутствует', 59.8670867, 30.3350903, 'https://vk.com/gagarinparkspb', 7, '12:00', '20:00', 'Бесплатно', 'Бесплатно')");

        db.execSQL("INSERT OR IGNORE INTO sights (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (27, " + draw_27 + ", 'Ростральные Колонны' , 'Адмиралтейская.', 'Биржевая пл.', false, '1805 г.','Архитектурные сооружения в центре Санкт-Петербурга, на Стрелке Васильевского острова. В XIX веке выполняли функцию фонарей порта столицы. Две ростральные колонны были возведены в 1805—1810 годах по проекту французского архитектора Тома де Томона, который украсил их рострами кораблей по обе стороны Васильевского острова. Это олицетворение показывает мощь " +
                "и величие морского флота государства, а также отсылает к древнеримскому обычаю украшать колонны рострами (лат. rostra, множественное число от лат. rostrum, нос корабля) поверженных (трофейных) вражеских кораблей.', 'Жан-Франсуа Тома де Томон', 59.9443163, 30.3049694, 'https://ru.wikipedia.org/wiki/%D0%A0%D0%BE%D1%81%D1%82%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5_%D0%BA%D0%BE%D0%BB%D0%BE%D0%BD%D0%BD%D1%8B_(%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3)', 3, '00:00', '24:00', 'Бесплатно', 'Бесплатно')");

        db.execSQL("INSERT OR IGNORE INTO sights (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (28, " + draw_28 + ", 'Памятник Николаю I' , 'Адмиралтейская.', ' Исаакиевская пл.', false, '1859 г.','Памятник Николаю I установлен на Исаакиевской площади в Санкт-Петербурге. Расположен между Мариинским дворцом и Исаакиевским собором. Памятник начал строиться в 1856 году после смерти императора по проекту архитектора Огюста Монферрана и был открыт 25 июня (7 июля) 1859 года. Памятник представляет собой 6-метровую конную статую Николая I работы П. К. Клодта, стоящую на пьедестале. Император изображён в парадном мундире Лейб-гвардии Конного полка. Конной натурой послужил любимый жеребец государя — Амалатбек." +
                "Пьедестал памятника работы Огюста Монферрана имеет эллиптическую форму и изготовлен из малинового карельского шокшинского кварцита и белого итальянского мрамора. Цоколь выполнен из серого сердобольского гранита.', ' Огюст Монферран', 59.9324583, 30.3085804, 'https://ru.wikipedia.org/wiki/%D0%A0%D0%BE%D1%81%D1%82%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5_%D0%BA%D0%BE%D0%BB%D0%BE%D0%BD%D0%BD%D1%8B_(%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3)', 3, '00:00', '24:00', 'Бесплатно', 'Бесплатно')");
        ...
        db.execSQL("INSERT OR IGNORE INTO sights_en (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (24, " + draw_24 + ", 'Tauride Gardens' , 'Chernyshevskaya.', 'Potemkinskaya street', false, '1783 y.', 'Monument of gardening art in the central part of St. Petersburg. It is located in the quarter bounded by Kirochnaya, Potemkinskaya, Shpalernaya and Tavricheskaya streets. The area of \u200B\u200Bthe Tauride Garden is 21.1 hectares.\n" +
                "The name of the garden, as well as the palace and street of the same name, are associated with the name of the Russian statesman and military leader of the time of Catherine II G. A. Potemkin, who received the title of Prince of Tauride and estate lands (garden and palace) for leading a successful attempt to conquer Crimea for Russia, also known from ancient times under the ancient Greek name of Taurida. As a result of the war, the Crimean Khanate ceased to threaten Russia. The garden and the palace formed a single landscape and architectural complex.', 'Missing', 59.9461679,  30.3746755, 'https://orangery-spb.ru/', 6, '06:00', '01:00', 'Free', 'Free')");

        db.execSQL("INSERT OR IGNORE INTO sights_en (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (25, " + draw_25 + ", 'Udelniy park' , 'Udelnaya.', 'Engels Ave., 28A', false, '1832 y.', 'A park located in the northern part of St. Petersburg, on the territory bounded by Engels Avenue, Ispytateley Avenue, Mark Gallai Street, Kolomyazhsky Avenue, and Akkuratova Street. In 1999, the Specific Park was classified as a cultural heritage site as an object of landscape architecture, and in 2013 it was recognized as an object of cultural heritage of regional significance.', 'Missing', 60.0051098,  30.3162046, 'https://ru.wikipedia.org/wiki/%D0%A3%D0%B4%D0%B5%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9_%D0%BF%D0%B0%D1%80%D0%BA', 6, '00:00', '24:00', 'Free', 'Free')");

        db.execSQL("INSERT OR IGNORE INTO sights_en (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (26, " + draw_26 + ", 'Gagarin park' , 'Park pobedy.', 'Kuznetsovskaya st., 25', false, '2003 y.', 'Gagarin Park is located on the territory of the Moscow Victory Park in St. Petersburg, south of the city center. With attractions for all tastes and a convenient location, this holiday destination is popular among families with children. The park is divided into zones that differ in theme and age categories. Most of the rides are located in the open air, except for a separate indoor game room with slot machines.', 'Missing', 59.8670867, 30.3350903, 'https://vk.com/gagarinparkspb', 7, '12:00', '20:00', 'Free', 'Free')");

        db.execSQL("INSERT OR IGNORE INTO sights_en (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (27, " + draw_27 + ", 'Rostral Columns' , 'Admiralteyskaya.', 'Birzhevaya Square.', false, '1805 y.','Architectural buildings in the center of St. Petersburg, on the Spit of Vasilyevsky Island. In the 19th century, they served as lanterns for the port of the capital. Two rostral columns were erected in 1805-1810 according to the design of the French architect Thomas de Thomon, who decorated them with the rostra of ships on both sides of Vasilyevsky Island. This personification shows the power and greatness of the state’s navy, and also refers to the ancient Roman custom of decorating columns with rostra (lat. rostra, " +
                "plural of lat. rostrum, the bow of the ship) of defeated (trophy) enemy ships.', 'Jean Francois Thomas de Thomon', 59.9443163, 30.3049694, 'https://ru.wikipedia.org/wiki/%D0%A0%D0%BE%D1%81%D1%82%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5_%D0%BA%D0%BE%D0%BB%D0%BE%D0%BD%D0%BD%D1%8B_(%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3)', 3, '00:00', '24:00', 'Free', 'Free')");

        db.execSQL("INSERT OR IGNORE INTO sights_en (id, image, sightName, metro, location, stared, dateOfBuild, discription, architect, latitude, longitude, website, type,  openTime, closeTime, price, priceForKids) VALUES (28, " + draw_28 + ", 'Monument to Nicholas I' , 'Admiralteyskaya.', 'Isaakievskaya sq.', false, '1859 y.','The monument to Nicholas I is installed on St. Isaac`s Square in St. Petersburg. Located between the Mariinsky Palace and St. Isaac`s Cathedral. The construction of the monument began in 1856 after the death of the emperor, designed by the architect Auguste Montferrand, and was opened on June 25 (July 7), 1859. The monument is a 6-meter equestrian statue of Nicholas I by P. K. Klodt, standing on a pedestal. The emperor is depicted in the ceremonial uniform of the Life Guards Cavalry Regiment. The sovereign`s favorite stallion, Amalatbek, was used as equestrian. " +
                "The plinth is made of gray Serdobol granite.', 'Auguste Montferrand', 59.9324583, 30.3085804, 'https://ru.wikipedia.org/wiki/%D0%A0%D0%BE%D1%81%D1%82%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5_%D0%BA%D0%BE%D0%BB%D0%BE%D0%BD%D0%BD%D1%8B_(%D0%A1%D0%B0%D0%BD%D0%BA%D1%82-%D0%9F%D0%B5%D1%82%D0%B5%D1%80%D0%B1%D1%83%D1%80%D0%B3)', 3, '00:00', '24:00', 'Free', 'Free')");
